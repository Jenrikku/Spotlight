...
:: For building Moonlight
::===================================================================

@echo off

echo Welcome to Spotlight-NET (Moonlight) cloning and building script.
...
dotnet build -c "Release Moonlight" -o ..\build

echo\
echo Moonlight-NET will now open if you press any key.
pause>null
